...
Structure your response as:
1. Overall payment discipline (on-time rate)
2. Recent trend — is behaviour improving or worsening?
3. Any concerning patterns (consecutive misses, growing arrears)
    ...
    if intent == "get_overdue_loans":
        ...
        summary = {
            ...
            "note": (
                ...
                "exported to CSV."
            ) if len(repayments) > 10 else None,
        }
...
def summarize_node(
    ...
    try:
        ...
        summarizer_response = _call_llm(system_prompt = SYSTEM_PROMPT,
        ...
        return {
            "final_response": summarizer_response,
            "error": None
        }
